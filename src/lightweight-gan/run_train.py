...
def run_train():
    ...
    args.add_argument('--attn_res_layers', type = list, default = [16, 32, 64, 128, 256, 512])
    args.add_argument('--latent_dim', type = int, default = 512)
    ...
    args.add_argument('--aug_prob', type = float, default = 0.6)
    ...
    args.add_argument('--gradient_accumulate_every', type = int, default = 4)
    args.add_argument('--evaluate_every', type = int, default = 10)
    args.add_argument('--checkpoint_every', type = int, default = 10)
    args.add_argument('--ttur_mult', type = 'int', default = 2)
